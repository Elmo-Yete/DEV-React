            ...
            <section className="flex bg-dev-to-card-color w-2/4">
              <article className="pb-5">
                <header>
                  ...
                  <div className="flex">
                    {tags.map((tagToShow, index) => {
                      return (
                        <a
                          key={index}
                          className="h-[25px] text-[14px] flex ms-9 my-5 hover:bg-yellow-100 cursor-pointer">
                          #{tagToShow}
                        </a>
                      );
                    })}
              ...
              <article className="bg-dev-to-card-color w-64 h-fit p-2 rounded-md">
                ...
                <div className="user-desc text-clip">
                  <p className="font-light">
                    Our mission is to get you into information security. We will
